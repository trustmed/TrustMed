    ...
    <section className="py-16 md:py-32">
      <div className="mx-auto max-w-5xl space-y-8 px-6 md:space-y-12">
        ...
        <img
          ...
          className="w-full h-auto rounded-lg shadow-2xl border border-gray-100/10"
        />
        ...
        <div className="relative mx-auto grid grid-cols-2 gap-x-3 gap-y-6 sm:gap-8 lg:grid-cols-4 pt-8">
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-medium text-black">Instant Access</h3>
            </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-medium text-black">Privacy First</h3>
            </div>
            <p className="text-black text-sm">
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-medium text-black">Global Reach</h3>
            </div>
            <p className="text-black text-sm">
