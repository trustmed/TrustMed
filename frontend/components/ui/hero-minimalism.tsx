...
.content .desc {
  ...
  max-width: 680px;
      ...
      <main className="hero">
        <div>
          ...
          <p className="subtitle">
            A minimal React starter focused on clarity, speed, and
            maintainability.
          </p>
        </div>
      </main>
      ...
      <section className="content">
        ...
        <p className="desc">
          Start with sensible defaults, ship without the noise, and scale your
          UI with confidence. Works across any app architecture.
        </p>
      </section>
    </section>
  );
