  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto text-center">
        <h2 className="text-4xl sm:text-5xl font-bold text-foreground mb-6">Ready to Take Control?</h2>
        <p className="text-xl text-muted-foreground mb-10 leading-relaxed">
          Join thousands of patients and healthcare providers building the future of healthcare data ownership and
          transparency.
        </p>
