  ...
  const steps = [
    {
      ...
      description:
        "Set up your secure blockchain-based digital identity that only you control with private keys.",
    },
    {
      number: "02",
      icon: "🏥",
      ...
      description:
        "Healthcare providers securely upload encrypted copies of your medical data to your profile.",
    },
    {
      number: "03",
      icon: "🔐",
      ...
      description:
        "Grant temporary access to doctors and revoke permissions anytime with a single click.",
    },
    {
      number: "04",
      icon: "⚡",
      ...
      description:
        "New healthcare providers access your complete history instantly with your permission.",
    },
  ];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-20">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            A simple, transparent process that puts you in complete control of
            your health data.
          </p>
        </div>
