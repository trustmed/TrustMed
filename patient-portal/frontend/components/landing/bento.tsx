...
const IntegrationCard = () => (
  <Card className="flex h-full flex-col">
    <CardHeader>
      <div className="mb-4 flex h-fit w-fit items-center justify-center rounded-full bg-transparent">
        {/* Replaced Emoji with Lock SVG */}
...
const StatisticCard = () => (
  <Card className="relative h-full w-full overflow-hidden">
    ...
    <CardContent className="relative z-10 flex h-full items-center justify-center p-0">
      <svg
        className="w-full sm:w-[150%] mt-auto"
        viewBox="0 0 366 231"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
...
const ProductivityCard = () => (
  <Card className="h-full">
    <CardContent className="flex h-full flex-col justify-end p-6">
      <div className="pt-6 lg:px-6 mb-4">
        <svg
          ...
          {[
            ...
            <li key={item} className="flex items-start gap-2">
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="lucide lucide-check mt-1 text-primary shrink-0"
              >
