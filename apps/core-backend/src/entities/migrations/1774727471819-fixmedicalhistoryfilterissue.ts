...
export class Fixmedicalhistoryfilterissue1774727471819 implements MigrationInterface {
  name = 'Fixmedicalhistoryfilterissue1774727471819';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "audit_logs" ADD "patient_id" character varying`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "audit_logs" DROP COLUMN "patient_id"`,
    );
