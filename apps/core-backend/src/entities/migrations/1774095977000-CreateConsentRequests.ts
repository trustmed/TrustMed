...
export class CreateConsentRequests1774095977000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DO $$ BEGIN ALTER TABLE "consent_requests" ADD CONSTRAINT "FK_490fca94f8560858aae172f8d2f" FOREIGN KEY ("requester_id") REFERENCES "auth_users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION; EXCEPTION WHEN duplicate_object THEN null; END $$;`,
    );
    await queryRunner.query(
      `DO $$ BEGIN ALTER TABLE "consent_requests" ADD CONSTRAINT "FK_d67c5e43670ff460aa6cafc4ed5" FOREIGN KEY ("patient_id") REFERENCES "auth_users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION; EXCEPTION WHEN duplicate_object THEN null; END $$;`,
    );
    await queryRunner.query(
      `DO $$ BEGIN ALTER TABLE "consent_requests" ADD CONSTRAINT "FK_afe2d4f2495e225421c31abf279" FOREIGN KEY ("record_id") REFERENCES "medical_records"("id") ON DELETE NO ACTION ON UPDATE NO ACTION; EXCEPTION WHEN duplicate_object THEN null; END $$;`,
    );
  }
