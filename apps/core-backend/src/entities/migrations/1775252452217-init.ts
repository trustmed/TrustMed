...
export class Init1775252452217 implements MigrationInterface {
  name = 'Init1775252452217';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "auth_users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdBy" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedBy" character varying, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "clerkUserId" character varying NOT NULL, "email" character varying NOT NULL, "firstName" character varying(100), "lastName" character varying(100), "isDemoDisabled" boolean NOT NULL DEFAULT false, "active" boolean NOT NULL DEFAULT true, CONSTRAINT "UQ_935cd86a07c11d84ef1c8bee8f1" UNIQUE ("clerkUserId"), CONSTRAINT "UQ_13d8b49e55a8b06bee6bbc828fb" UNIQUE ("email"), CONSTRAINT "PK_c88cc8077366b470dafc2917366" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."institutions_status_enum" AS ENUM('ACTIVE', 'SUSPENDED')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."guardian_links_relationship_enum" AS ENUM('FATHER', 'MOTHER', 'GUARDIAN')`,
    );
    await queryRunner.query(
      `CREATE TABLE "guardian_links" ("id" BIGSERIAL NOT NULL, "minor_did" character varying NOT NULL, "guardian_did" character varying NOT NULL, "relationship" "public"."guardian_links_relationship_enum" NOT NULL, "doc_reference" character varying, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_a5ef0b9de24a0d6e502b752df40" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "record_registry" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdBy" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedBy" character varying, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "patient_did" character varying NOT NULL, "institution_id" uuid, "record_hash" character varying NOT NULL, "vault_id" character varying, "metadata" json, "is_revoked" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_aafcef6fd251a4657e53480f905" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."access_requests_status_enum" AS ENUM('PENDING', 'GRANTED', 'REJECTED', 'EXPIRED')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."medical_records_category_enum" AS ENUM('lab_report', 'prescription', 'imaging', 'discharge_summary', 'vaccination', 'other')`,
    );
    await queryRunner.query(
      `CREATE TABLE "medical_records" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdBy" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedBy" character varying, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "patientId" uuid NOT NULL, "uploaderId" uuid NOT NULL, "s3Uri" text, "documentHash" text, "encryptedAesKey" text, "original_file_name" text, "mime_type" character varying(100), "file_name" character varying, "file_url" character varying, "file_type" character varying, "file_size" bigint, "category" "public"."medical_records_category_enum" NOT NULL DEFAULT 'other', "notes" text, "doctor_name" character varying(200), "hospital_name" character varying(200), "record_date" date, "person_id" uuid, CONSTRAINT "PK_c200c0b76638124b7ed51424823" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."consent_requests_status_enum" AS ENUM('PENDING', 'ACCEPTED', 'REJECTED')`,
    );
    await queryRunner.query(
      `CREATE TABLE "consent_requests" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdBy" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedBy" character varying, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "requester_id" uuid NOT NULL, "patient_id" uuid NOT NULL, "record_id" uuid NOT NULL, "status" "public"."consent_requests_status_enum" NOT NULL DEFAULT 'PENDING', "expires_at" TIMESTAMP, CONSTRAINT "PK_6e56fb576d9de99095cc4a8ba65" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."appointments_status_enum" AS ENUM('pending', 'accepted', 'cancelled')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "notification_queue" ADD CONSTRAINT "FK_880948d3ddc430e2295a16af4f4" FOREIGN KEY ("target_did") REFERENCES "global_patients"("did") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "guardian_links" ADD CONSTRAINT "FK_1d509f01dc81b05afe415ff7ccd" FOREIGN KEY ("minor_did") REFERENCES "global_patients"("did") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "guardian_links" ADD CONSTRAINT "FK_cc05f5ee485e0bfdeb54ad68551" FOREIGN KEY ("guardian_did") REFERENCES "global_patients"("did") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "record_registry" ADD CONSTRAINT "FK_668239e465f8641ef471809ada7" FOREIGN KEY ("patient_did") REFERENCES "global_patients"("did") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "record_registry" ADD CONSTRAINT "FK_ae405fcd34eb0638e71a457d69d" FOREIGN KEY ("institution_id") REFERENCES "institutions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "access_requests" ADD CONSTRAINT "FK_9d26ef2430f42a938e98e67a7ed" FOREIGN KEY ("requester_inst_id") REFERENCES "institutions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "access_requests" ADD CONSTRAINT "FK_d1d629eeb65582f358626ef4966" FOREIGN KEY ("patient_did") REFERENCES "global_patients"("did") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "access_requests" ADD CONSTRAINT "FK_7a458cefaaa9060d4ba4e2c2825" FOREIGN KEY ("record_registry_id") REFERENCES "record_registry"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "consent_requests" ADD CONSTRAINT "FK_490fca94f8560858aae172f8d2f" FOREIGN KEY ("requester_id") REFERENCES "auth_users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "consent_requests" ADD CONSTRAINT "FK_d67c5e43670ff460aa6cafc4ed5" FOREIGN KEY ("patient_id") REFERENCES "auth_users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "consent_requests" ADD CONSTRAINT "FK_afe2d4f2495e225421c31abf279" FOREIGN KEY ("record_id") REFERENCES "medical_records"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "consent_requests" DROP CONSTRAINT "FK_afe2d4f2495e225421c31abf279"`,
    );
    await queryRunner.query(
      `ALTER TABLE "consent_requests" DROP CONSTRAINT "FK_d67c5e43670ff460aa6cafc4ed5"`,
    );
    await queryRunner.query(
      `ALTER TABLE "consent_requests" DROP CONSTRAINT "FK_490fca94f8560858aae172f8d2f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "medical_records" DROP CONSTRAINT "FK_d1792275ff345f83dd3760becdb"`,
    );
    await queryRunner.query(
      `ALTER TABLE "access_requests" DROP CONSTRAINT "FK_7a458cefaaa9060d4ba4e2c2825"`,
    );
    await queryRunner.query(
      `ALTER TABLE "access_requests" DROP CONSTRAINT "FK_d1d629eeb65582f358626ef4966"`,
    );
    await queryRunner.query(
      `ALTER TABLE "access_requests" DROP CONSTRAINT "FK_9d26ef2430f42a938e98e67a7ed"`,
    );
    await queryRunner.query(
      `ALTER TABLE "record_registry" DROP CONSTRAINT "FK_ae405fcd34eb0638e71a457d69d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "record_registry" DROP CONSTRAINT "FK_668239e465f8641ef471809ada7"`,
    );
    await queryRunner.query(
      `ALTER TABLE "guardian_links" DROP CONSTRAINT "FK_cc05f5ee485e0bfdeb54ad68551"`,
    );
    await queryRunner.query(
      `ALTER TABLE "guardian_links" DROP CONSTRAINT "FK_1d509f01dc81b05afe415ff7ccd"`,
    );
    await queryRunner.query(
      `ALTER TABLE "notification_queue" DROP CONSTRAINT "FK_880948d3ddc430e2295a16af4f4"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP TYPE "public"."consent_requests_status_enum"`,
    );
    await queryRunner.query(`DROP TABLE "medical_records"`);
    await queryRunner.query(
      `DROP TYPE "public"."medical_records_category_enum"`,
    );
    ...
    await queryRunner.query(
      `DROP TYPE "public"."guardian_links_relationship_enum"`,
    );
    await queryRunner.query(`DROP TABLE "notification_queue"`);
    await queryRunner.query(
      `DROP TYPE "public"."notification_queue_type_enum"`,
    );
